...
import com.qweather.vastgui.client.model.historical.HistoricalAir
import com.qweather.vastgui.client.model.historical.HistoricalWeather
import com.qweather.vastgui.client.utils.DateUtil
 ...
 */
class TimeMachine internal constructor(override val client: QWeather) : Api {

    override val url: String = "/v7/historical"
    ...
    suspend fun weatherHistory(
        ...
        client.httpClient.get("$url/weather") {
            url {
