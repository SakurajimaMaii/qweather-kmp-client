...
package com.qweather.vastgui.client.model.warning
...
data class Warning(
     ...
     *
     * @property endTime
     * 灾害[预警结束时间](https://dev.qweather.com/docs/resource/warning-info/#expiry-time)，可能为空。
     * @property id 本条预警的唯一标识，可判断本条预警是否已经存在。
     * @property level 预警等级（已弃用），不要再使用这个字段，该字段已弃用， 目前返回为空或未更新的值。请使用 [severity]
     * 和 [severityColor] 代替。
     * @property pubTime 预警发布时间。
     * @property related 与本条预警相关联的预警ID，当预警状态为 cancel 或 update 时返回。可能为空
     * @property sender 预警发布单位，可能为空。
     * @property startTime 预警开始时间，可能为空。
     * @property status 预警信息的发布
     * [状态](https://dev.qweather.com/docs/resource/warning-info/#status) 。
     * @property text 预警详细文字描述。
     * @property title 预警信息标题。
     * @property type 预警
     * [类型ID](https://dev.qweather.com/docs/resource/warning-info/#warning-type)
     * 。
     * @property typeName 预警
     * [类型名称](https://dev.qweather.com/docs/resource/warning-info/#warning-type)
     * 。
     * @property severity 预警
     * [严重等级](https://dev.qweather.com/docs/resource/warning-info/#severity) 。
     * @property severityColor 预警
     * [严重等级颜色](https://dev.qweather.com/docs/resource/warning-info/#severity-color)，可能为空。
     * @property urgency 预警
     * [信息的紧迫程度](https://dev.qweather.com/docs/resource/warning-info/#urgency)
     * ，可能为空。
     * @property certainty 预警
     * [信息的确定性](https://dev.qweather.com/docs/resource/warning-info/#certainty)
     * ，可能为空。
     */
    @Serializable
    data class Warning(
